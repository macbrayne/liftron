...
void makeEveningCsvDocument(Evening today) {
  ...
  lines[4] = "";
  lines[5] = "Umsatz: " + today.salesVolume + "E"; //€
  lines[6] = "";
  lines[7] = "Kassenstand vorher: " + today.cashBefore + "E"; //€
  lines[8] = "Kassenstand nachher gezahlt: " + today.cashAfterCounted + "E"; //ä, €
  lines[9] = "";
  lines[10] = "Kassenstand nachher erwartet: " + today.cashAfterExpected + "E"; //€
  lines[11] = "Abweichung von der Erwartung: " + today.cashDifference + "E"; //€
  lines[12] = "";
